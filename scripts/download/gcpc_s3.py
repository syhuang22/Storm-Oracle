...
def download_gpcp_data(year, bucket_name, s3_path_prefix):
    base_url = f'https://www.ncei.noaa.gov/data/global-precipitation-climatology-project-gpcp-daily/access/{year}/'
...
if __name__ == "__main__":
    ...
    s3_path_prefix = 'noaa/raw/gpcp'  # S3 path prefix
    attribute = 'gpcp'

    # Configure logging
    log_file = '/home/azureuser/Storm-Oracle/logs/download_gpcp.log'
    ...
    # Download and upload GPCP data
    for year in years:
        download_gpcp_data(year, BUCKET_NAME, s3_path_prefix)
